...
module.exports = async (loginId, symbol, orderId, buyType, volume) => {
  return new Promise((resolve, reject) => {
    // console.time('closeTime--');
    ...
    req.Auth(function (error) {
      ...
      console.log('[close req]', JSON.stringify(body));
      req.Post(url, JSON.stringify(body), function (error, res, body) {
        ...
        req.Post(url2, JSON.stringify(body), function (error, res, body) {
          ...
          console.log('[close res]', JSON.stringify(result2));
          // 結速auth連線
